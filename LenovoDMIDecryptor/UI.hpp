...
namespace UI
{
	...
	constexpr const ImU32 STRUCTURE_PANEL_LDBG_OP_SET_DATA_COLOR		= IM_COL32(140, 170, 255, 255);
	constexpr const ImU32 STRUCTURE_PANEL_LDBG_OP_PROTECT_COLOR			= IM_COL32(200, 140, 255, 255);
	constexpr const ImU32 STRUCTURE_PANEL_LDBG_OP_UNPROTECT_COLOR		= IM_COL32(120, 200, 200, 255);
	constexpr const ImU32 STRUCTURE_PANEL_LDBG_OP_UNKNOWN_COLOR			= IM_COL32(150, 150, 150, 255);
